        ...
        <Homepage>
          ...
          <section>
            ...
            <div>
              ...
              <ButtonsContainer>
                <Option ref={el => difficultyRef.current.push(el)} text={'Fácil'} value={'easy'} name={'difficultyQuestions'} />
                <Option ref={el => difficultyRef.current.push(el)} text={'Médio'} value={'medium'} name={'difficultyQuestions'} />
                <Option ref={el => difficultyRef.current.push(el)} text={'Díficil'} value={'hard'} name={'difficultyQuestions'} />
              </ButtonsContainer>
            </div>
          </section>
          <Wrapper>
